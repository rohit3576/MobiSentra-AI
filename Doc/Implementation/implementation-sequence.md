...
| 6 | Event Engine + Severity | golden-file tests pass | 🟡 In progress — 6.1a ✅ 6.1b ✅ 6.2 ✅ **6.3a ✅** (run-loop wiring: envelopes → `runs/events/<cam>.envelopes.jsonl`, model_versions stamped, production smoke 60 rows → 55 schema-valid envelopes w/ 5 debounce-suppressed; suite 315+4); next 6.3b fight evidence |
