...
| 8 | Backend Services | restart-safe consumer; event < 1 s to dashboard | ✅ **PASSED + CLOSED 2026-08-31** — 8.1a→8.5 + 8.4b all ✅; Gate 8 ticked 3/3 (SIGKILL-mid-stream 150/150 zero-loss/zero-dup; worst publish→WS 23 ms ≈40× headroom; ack/escalate audit rows live-asserted); full-edge-path PASS ×2; backend 87/87 + tsc clean; compose service verified end-to-end with zero host tooling; report: `phase-8-completion.md` |
