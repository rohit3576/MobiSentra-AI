...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 Plan **approved 2026-08-28** — execution division in [phase-5-plan.md](./phase-5-plan.md) (sub-steps 5.1a–5.5c; only 5.5b needs owner input). Owner-sanctioned start with Gates 2–4 verdicts still open (tracker rows above) |
