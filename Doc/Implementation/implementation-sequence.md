...
| 8 | Backend Services | restart-safe consumer; event < 1 s to dashboard | 🟡 In progress — 8.1b ✅ + **8.1a ✅** (typed EventRecord mapping: ajv-first then guard extraction, camera-precedence decision, source fallbacks never crash; 14/14, backend 26/26 + tsc clean); next 8.2 Redis dedupe |
