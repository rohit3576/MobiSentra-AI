...
| 7 | Edge Messaging | 10-min blackout → zero loss, zero dupes | 🟡 In progress — 7.1a–7.1c ✅ + **7.2 ✅** (live round trip: 100/100 envelopes → Kafka byte-intact + ordered via EMQX/bridge; PahoTransport live-proven; gated skip path tested); next 7.3a bridge hardening |
