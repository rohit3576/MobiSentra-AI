...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 5.1–5.4 ✅ shipped; 5.5a/5.5b ✅ (UBI official + Hockey torrent, no creds needed); **5.5c baseline recorded, Gate 5 open** (UBI 11/40 full-length; negatives 22 alerts — evidence in runs/*.json; perf fixed 6× realtime; tuning PAUSED per owner stop directive). Owner fork: tune / defer to Phase 6 / accept documented |
