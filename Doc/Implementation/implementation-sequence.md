...
| 7 | Edge Messaging | 10-min blackout → zero loss, zero dupes | 🟡 In progress — 7.1a–7.2 ✅ + **7.3a ✅** (bridge lib extracted: mapTopic w/ dot-gotcha + bounded TTL suppressor, vitest 10/10 + tsc clean, index.ts rewired); next 7.3b backpressure |
