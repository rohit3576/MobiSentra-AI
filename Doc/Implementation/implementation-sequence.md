...
| 7 | Edge Messaging | 10-min blackout → zero loss, zero dupes | 🟡 In progress — plan approved 2026-08-29; **7.1a ✅** (SQLite write-ahead spool: id-dedupe surviving sends, cap+persisted drop counter, crash-surrogate reopen; 11/11, suite 338+4); next 7.1b publisher |
