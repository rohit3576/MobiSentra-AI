...
| 6 | Event Engine + Severity | golden-file tests pass | 🟡 In progress — plan approved 2026-08-29; 6.1a ✅ (envelope builder) + **6.1b ✅** (debounce core: cooldown keys, occupancy family key + de-escalation re-arm, fight re-fire → CRITICAL, suppression telemetry, purity guard; 17/17, suite 279+4); next 6.2 severity.yaml |
