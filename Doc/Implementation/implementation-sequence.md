...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 Plan **approved 2026-08-28** — executing: 5.1 ✅ **complete** (a: A2 weights+manifest; b: runtime = ONNX explicit-states 10.3 ms; c: `vision/action.py` ActionScorer, 10/10 stub tests, real-clip 11.4 ms mean, P(No_Fight)=0.99); next 5.2 pair-finding. Only 5.5b needs owner input. Owner-sanctioned start with Gates 2–4 verdicts still open (tracker rows above) |
