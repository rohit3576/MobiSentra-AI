...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 Plan **approved 2026-08-28** — executing: 5.1 ✅, 5.2 ✅ (pairs.py 12/12 tests + real-footage pair formation, bus1 tracks 4/11 @t=12s); next 5.3 signal fusion. Only 5.5b needs owner input. Owner-sanctioned start with Gates 2–4 verdicts still open (tracker rows above) |
