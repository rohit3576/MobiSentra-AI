...
| 7 | Edge Messaging | 10-min blackout → zero loss, zero dupes | 🟡 In progress — 7.1a–7.3a ✅ + **7.3b ✅** (bridge hardened: persistent-session MQTT disconnect backpressure + bounded buffer + watermark-probe recovery — two live flaws found & fixed; kill rehearsal 10/10 automatic recovery; vitest 15/15); next 7.4 fault-injection suite + gate soak |
