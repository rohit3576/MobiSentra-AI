...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 Plan **approved 2026-08-28** — executing: 5.1 ✅, 5.2 ✅, 5.3 ✅ (fight.py 4-signal fusion — model never alerts alone; wired beside fall; 9+4 tests; real-model 0 FP on bus1); next 5.4 negatives corpus. Only 5.5b needs owner input. Owner-sanctioned start with Gates 2–4 verdicts still open (tracker rows above) |
