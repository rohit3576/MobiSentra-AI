...
| 6 | Event Engine + Severity | golden-file tests pass | 🟡 In progress — plan approved 2026-08-29; **6.1a ✅** (envelope builder: rows → CloudEvents v0, 27/27 tests, all outputs schema-valid, drift-guarded enums); next 6.1b debounce core |
