...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 Plan **approved 2026-08-28** — executing: 5.1a ✅ (A2 weights+manifest), 5.1b ✅ (**runtime = ONNX explicit-states, 10.6 ms/frame, semantics verified**); next 5.1c. Only 5.5b needs owner input. Owner-sanctioned start with Gates 2–4 verdicts still open (tracker rows above) |
