...
| 5 | Altercation Detection | ≥ 85% fight clips; 0 alerts on 30 min normal footage | 🟡 Plan **approved 2026-08-28** — executing: 5.1–5.4 ✅ (5.4: 147-clip/42.4-min negatives corpus + one-command FP soak; **baseline census 22 alerts — tuning is 5.5 work**, assist+crowd categories already 0); next 5.5 evaluation (needs owner Kaggle creds at 5.5b). Owner-sanctioned start with Gates 2–4 verdicts still open (tracker rows above) |
