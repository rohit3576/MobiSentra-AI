...
| 7 | Edge Messaging | 10-min blackout → zero loss, zero dupes | 🟡 In progress — 7.1a ✅ + **7.1b ✅** (EventPublisher: write-ahead, PUBACK-batched mark_sent, FIFO replay-once, backoff fn, bg loop; 11/11, suite 349+4); next 7.1c wiring |
