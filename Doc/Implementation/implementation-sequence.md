...
| 8 | Backend Services | restart-safe consumer; event < 1 s to dashboard | 🟡 In progress — 8.1a ✅ 8.1b ✅ + **8.2 ✅** (Redis SET-NX dedupe, fail-open on outage, TTL 86400 locked; 5/5, backend 31/31 + tsc clean); next 8.3a PG schema + migrations |
