...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **DRAFT, awaiting approval**; division 8.1a–8.4b (consumer w/ manual commits, Redis dedupe, PG + visible SQL, Socket.IO rooms, Fastify API, integration + restart gate); no owner-input steps; defaults proposed |
