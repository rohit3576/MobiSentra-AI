...
| [`phase-7-plan.md`](./phase-7-plan.md) | Phase 7 (edge messaging: spool → MQTT → bridge → Kafka) design plan — **APPROVED 2026-08-29, executing one-by-one**; 7.1a ✅ + **7.1b ✅** (write-ahead publisher w/ replay-once + backoff; 11/11; suite 349+4); remaining 7.1c–7.4b (wiring, bridge hardening, fault-injection + gate soak) |
