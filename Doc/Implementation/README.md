...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **APPROVED 2026-08-29, executing one-by-one**; 8.1b + 8.1a + 8.2 + 8.3a + 8.3c + 8.3b + **8.4a ✅** (consumer wrapper, typed records, dedupe, migrations, WS rooms, write-path pipeline, fastify REST + evidence route; backend 83/83 + tsc clean, live smokes passed); remaining 8.5, 8.4b |
