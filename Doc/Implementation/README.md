...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **APPROVED 2026-08-29, executing one-by-one**; **8.1b ✅ + 8.1a ✅** (consumer wrapper + typed record mapping; backend 26/26 + tsc clean); remaining 8.2–8.5, 8.4b |
