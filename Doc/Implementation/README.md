...
| [`phase-7-plan.md`](./phase-7-plan.md) | Phase 7 (edge messaging: spool → MQTT → bridge → Kafka) design plan — **APPROVED 2026-08-29, executing one-by-one**; **7.1a ✅** (SQLite write-ahead spool, 11/11; suite 338+4); remaining 7.1b–7.4b (publisher, wiring, bridge hardening, fault-injection + gate soak) |
