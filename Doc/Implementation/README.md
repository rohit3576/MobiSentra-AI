...
| [`phase-7-plan.md`](./phase-7-plan.md) | Phase 7 (edge messaging: spool → MQTT → bridge → Kafka) design plan — **APPROVED 2026-08-29, executing one-by-one**; 7.1a–**7.4a ✅** (spool, publisher, wiring, live round trip, hardened bridge, fault-injection suite); remaining 7.4b gate soak = Gate 7 evidence |
