...
| [`phase-7-plan.md`](./phase-7-plan.md) | Phase 7 (edge messaging: spool → MQTT → bridge → Kafka) design plan — **APPROVED 2026-08-29, executing one-by-one**; 7.1a–**7.1c ✅** (spool, publisher, wiring + paho v2 adapter + `--publish` default-off; suite 362+4); remaining 7.2–7.4b (Kafka integration, bridge hardening, fault-injection + gate soak) |
