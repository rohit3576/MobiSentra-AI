...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **APPROVED 2026-08-29, executing one-by-one**; 8.1b + 8.1a + 8.2 + 8.3a + 8.3c + **8.3b ✅** (consumer wrapper, typed records, Redis dedupe fail-open, PG migrations, Socket.IO rooms, write-path pipeline w/ A1 analytics+occupancy; backend 65/65 + tsc clean, live smoke passed); remaining 8.4a, 8.5, 8.4b |
