...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **Gate 8 PASSED 3/3 2026-08-31**; 8.1a–8.5 all ✅ (consumer, dedupe, migrations, WS, pipeline, REST+evidence, integration suite: 23 ms latency, SIGKILL-mid-stream 150/150 zero-loss, full-edge-path PASS; backend 87/87); remaining 8.4b compose service + completion report |
