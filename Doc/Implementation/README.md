...
| [`phase-7-plan.md`](./phase-7-plan.md) | Phase 7 (edge messaging: spool → MQTT → bridge → Kafka) design plan — **APPROVED 2026-08-29, executing one-by-one**; 7.1a–**7.2 ✅** (spool, publisher, wiring, live Kafka round trip 100/100 byte-intact); remaining 7.3a–7.4b (bridge hardening, fault-injection + gate soak) |
