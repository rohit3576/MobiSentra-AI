...
| [`phase-6-plan.md`](./phase-6-plan.md) | Phase 6 (event engine + severity) design plan — **APPROVED 2026-08-29, executing one-by-one**; 6.1a ✅ (envelope builder) + 6.1b ✅ (debounce core) + 6.2 ✅ (severity.yaml + strict loader, YAML-edit proof; suite 306+4); remaining 6.3a–6.4 (wiring + fight evidence, golden files) |
