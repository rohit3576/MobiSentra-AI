...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **APPROVED 2026-08-29, executing one-by-one** (started at 8.1b per owner); **8.1b ✅** (consumer wrapper w/ manual commits, 6/6); remaining 8.1a, 8.2–8.5, 8.4b |
