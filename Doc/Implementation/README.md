...
| [`phase-7-plan.md`](./phase-7-plan.md) | Phase 7 (edge messaging: spool → MQTT → bridge → Kafka) design plan — **APPROVED 2026-08-29, executing one-by-one**; 7.1a–**7.3b ✅** (spool, publisher, wiring, live Kafka round trip, bridge hardened w/ live kill rehearsal); remaining 7.4a–7.4b (fault-injection suite + gate soak) |
