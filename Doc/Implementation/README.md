...
| [`phase-6-plan.md`](./phase-6-plan.md) | Phase 6 (event engine + severity) design plan — **APPROVED 2026-08-29, executing one-by-one**; 6.1a ✅ (envelope builder) + 6.1b ✅ (debounce core w/ purity guard, 17/17); remaining 6.2–6.4 (severity.yaml, wiring + fight evidence, golden files); zero owner-input steps |
