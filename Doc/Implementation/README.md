...
| [`phase-8-plan.md`](./phase-8-plan.md) | Phase 8 (backend services) design plan — **APPROVED 2026-08-29, executing one-by-one**; 8.1b + 8.1a + 8.2 + **8.3a ✅** (consumer wrapper, typed records, Redis dedupe fail-open, PG migrations + no-ORM runner live-applied; backend 40/40 + tsc clean); remaining 8.3c–8.5, 8.4b |
